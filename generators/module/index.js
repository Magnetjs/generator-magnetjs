...
module.exports = class extends generator_1.BasicQuestion {
    ...
    flyfile() {
        this.fs.copy(this.templatePath('flyfile.js'), this.destinationPath('flyfile.js'));
    }
    readMe() {
    ...
    source() {
        ...
        this.fs.copyTpl(this.templatePath(`${lang}/config.${lang}`), this.destinationPath(`src/config/${moduleName}.${lang}`), { moduleName, moduleNameCap });
        this.fs.copyTpl(this.templatePath(`${lang}/index.${lang}`), this.destinationPath(`src/index.${lang}`), { moduleName, moduleNameCap });
    }
    yarn() {
